...
namespace IIS.123
{
    ...
    [View("ТоварE", new string[] {
            ...
            "Производитель.Страна as \'Страна\'",
            "Поставщик as \'Поставщик\'",
            "Поставщик.Поставщик as \'Поставщик\'"}, Hidden=new string[] {
            "Производитель.Страна",
            "Поставщик.Поставщик"})]
    [MasterViewDefineAttribute("ТоварE", "Производитель", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Страна")]
    ...
    public class Товар : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.123.Производитель fПроизводитель;
        
        private IIS.123.Поставщик fПоставщик;
        ...
        [PropertyStorage(new string[] {
                "Поставщик"})]
        [NotNull()]
        public virtual IIS.123.Поставщик Поставщик
        {
            get
            {
                ...
                IIS.123.Поставщик result = this.fПоставщик;
        ...
        [PropertyStorage(new string[] {
                "Производитель"})]
        [NotNull()]
        public virtual IIS.123.Производитель Производитель
        {
            get
            {
                ...
                IIS.123.Производитель result = this.fПроизводитель;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварE", typeof(IIS.123.Товар));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ТоварL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварL", typeof(IIS.123.Товар));
                }
            }
        }
    }
