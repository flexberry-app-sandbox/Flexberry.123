...
namespace IIS.123
{
    ...
    public class Оплата : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.123.Способ1 fСпособ;
        
        private System.DateTime fДата;
        
        private IIS.123.Заказ fЗаказ;
        ...
        public virtual IIS.123.Способ1 Способ
        {
            get
            {
                ...
                IIS.123.Способ1 result = this.fСпособ;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.123.Заказ.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Заказ"})]
        public virtual IIS.123.Заказ Заказ
        {
            get
            {
                ...
                IIS.123.Заказ result = this.fЗаказ;
    ...
    public class DetailArrayOfОплата : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.123.DetailArrayOfОплата members)

        // *** End programmer edit section *** (IIS.123.DetailArrayOfОплата members)
        ...
        /// </summary>
        public DetailArrayOfОплата(IIS.123.Заказ fЗаказ) : 
                base(typeof(Оплата), ((ICSSoft.STORMNET.DataObject)(fЗаказ)))
        {
        }
        
        public IIS.123.Оплата this[int index]
        {
            get
            {
                return ((IIS.123.Оплата)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.123.Оплата dataobject)
        {
