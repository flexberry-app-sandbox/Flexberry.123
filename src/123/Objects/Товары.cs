...
namespace IIS.123
{
    ...
    public class Товары : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТоварыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТоварыE", typeof(IIS.123.Товары));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТовары : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.123.DetailArrayOfТовары members)

        // *** End programmer edit section *** (IIS.123.DetailArrayOfТовары members)
        ...
        /// </summary>
        public DetailArrayOfТовары(IIS.123.Заказ fЗаказ) : 
                base(typeof(Товары), ((ICSSoft.STORMNET.DataObject)(fЗаказ)))
        {
        }
        
        public IIS.123.Товары this[int index]
        {
            get
            {
                return ((IIS.123.Товары)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.123.Товары dataobject)
        {
